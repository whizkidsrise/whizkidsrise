...
from snakeeyes.blueprints.contact2 import contact2
from snakeeyes.blueprints.user import user
from snakeeyes.blueprints.user.models import User
from snakeeyes.blueprints.user2 import user2
...
def create_app(settings_override=None):
    ...
    app.register_blueprint(contact2)
    app.register_blueprint(user)
    app.register_blueprint(user2)
    extensions(app)
